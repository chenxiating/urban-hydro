...
def simulation(main_df, mean_rainfall_inch,nodes_num,beta,i,min_diam,changing_diam):
    make_SWMM_inp.main(main_df = main_df, antecedent_soil_moisture=0.5, mean_rainfall_inch=mean_rainfall_inch,nodes_num=nodes_num,beta=beta,i=i,count=0,mp=True,min_diam=min_diam,changing_diam=changing_diam)
